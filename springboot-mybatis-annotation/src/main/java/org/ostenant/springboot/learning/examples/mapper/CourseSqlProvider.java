...
import org.ostenant.springboot.learning.examples.model.CourseExample.Criteria;
import org.ostenant.springboot.learning.examples.model.CourseExample.Criterion;
...
public class CourseSqlProvider {
    ...
    public String selectByExample(CourseExample example) {
        ...
        sql.SELECT("lesson_period");
        sql.SELECT("total_course");
        sql.FROM("course");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLessonPeriod() != null) {
            sql.SET("lesson_period = #{record.lessonPeriod,jdbcType=DOUBLE}");
        }

        if (record.getTotalCourse() != null) {
            sql.SET("total_course = #{record.totalCourse,jdbcType=INTEGER}");
        }
