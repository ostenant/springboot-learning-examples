...
public abstract class AbstractCoreSQL<T> {
    ...
    private static class SQLStatement {
        ...
        private void multiValueSqlClause(AbstractCoreSQL.SafeAppendable builder, String keyword, List<List<String>> multiParts, String open, String close, String conjunction) {
